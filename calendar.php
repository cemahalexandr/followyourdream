        ...
        <div class="modal-content">
            <div class="modal-header modal-header__first">
                ...
                <div class="modal-header__content template-header-text">
                    <h3 class="modal-title modal-header__content-place" id="myModalLabel">Тай + Камбоджа</h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="cover_block container750">
                        <div class="container">
                            ...
                            <div class="modal-body-top-button">
                                <a class="button">
                                    <button class="button tour_btn_takepart_orange tour_btn_witout_marginbottom" onclick="openTakePartModal()">ПРИНЯТЬ УЧАСТИЕ В ЭКСПЕДИЦИИ</button>
                                </a>
                            </div>
                        </div>
                    </div>
