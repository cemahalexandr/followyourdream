    ...
    <section class="arctic-body template-body">
        <div class="container">
            ...
            <div class="arctic-body-iceland">
                ...
                <p>
                    <span>Контрастная и суровая природа этой страны каким-то чудом осталась почти или полностью нетронутой. Кажется, что время здесь остановилось, а по земле никогда не ступала нога человека. </span>
                    <span>Вот почему Исландия — это настоящая мечта фотографов и путешественников, которых влечет шанс запечатлеть первозданную, мистическую силу и красоту северной природы. Да и таких захватывающих пейжазей, пожалуй, не встретишь больше на Земле.</span>
                </p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-push-2 col-md-8 col-md-push-2 col-sm-8 col-sm-push-2 col-xs-8 col-xs-push-2">
                        <div class="temp-slider-wrap">
                            <div><img src="img/header-img-1.jpg" alt=""></div>
                            <div><img src="img/header-img-2.jpg" alt=""></div>
                            <div><img src="img/header-img-3.jpg" alt=""></div>
                            <div><img src="img/header-img-4.jpg" alt=""></div>
                            <div><img src="img/header-img-5.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
